    ...
    <header className="fixed top-0 left-0 right-0 z-[60] bg-[#050505]/80 backdrop-blur-2xl border-b border-white/5 hidden md:block">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center bg-neutral-900 border border-white/5 px-4 py-2 rounded-2xl space-x-3 group cursor-pointer hover:border-amber-500/30 transition-all">
          ...
          <button className="w-10 h-10 rounded-2xl overflow-hidden ring-2 ring-white/5 hover:ring-red-600 transition-all">
